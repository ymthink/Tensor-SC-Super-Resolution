...
def sample_data(train_data, n_samples=10240):
    ...
    X_l = np.zeros((hp.patch_size*hp.patch_size*1, n_samples, hp.patch_size))
    count = 0
    #蓄水池抽样
    for i in range(len(train_data)):
        ...
        img_lp = tensor_block_3d(img_l, hp.patch_size, hp.step)
...
if __name__ == '__main__':
    ...
    X_h, X_l, img_h = sample_data(train_data=x_train, n_samples=10240)
